...
class ModelsContainer:
    def __init__(self):
        ...
        state_path = os.path.normpath('/Users/Harshita/Downloads/ChatTime-new/test_0843_model_alexnet_ann_bs128_lr0_001_epoch149')
    ...
    def detect_image_emotion(self, filename):
        ...
        new_img_path = os.path.normpath('/Users/Harshita/Downloads/ChatTime-new/img.jpg')
        ...
        img2[:,:,1] = grey
        img2[:,:,2] = grey
        new_grey_img_path = os.path.normpath('/Users/Harshita/Downloads/ChatTime-new/img.jpg')
        ...
        imgs_path = os.path.normpath('/Users/Harshita/Downloads/ChatTime-new/img_grey.jpg')
        imgs.save(imgs_path)
    ...
    def combine_results(self, image_file):
        facial_expr = self.detect_image_emotion(image_file)

        # RNN: 0 = negative, 1 = positive,
        if(facial_expr == 'angry'):
            return "Del"
        elif (facial_expr == 'disgusted'):
            return "Warn"
        else:
            return "Pass"
